            ...
            <nav class="navbar navbar-expand-sm navbar-default">
                ...
                <div id="main-menu" class="main-menu collapse navbar-collapse">
                    <ul class="nav navbar-nav">
                        ...
                        @permission(['Permission Update','All','Post Add','Permission'])
                        <li>
                        ...
                        @permission(['Permission Update','All'])
                        <li>
                            <a href="{{url('/back/authors')}}"> <i class="menu-icon fa fa-users"></i>Authors </a>
                        </li>
                        @endpermission
                        ...
                        <li>
                            <a href="{{url('/back/posts')}}"> <i class="menu-icon fa fa-edit"></i>Posts</a>
                        </li>
                        @endpermission
                        @permission(['System Settings','All'])
                        <li>
                            <a href="{{url('/back/settings')}}"> <i class="menu-icon fa fa-cogs"></i>Settings</a>
                        </li>
                        @endpermission
